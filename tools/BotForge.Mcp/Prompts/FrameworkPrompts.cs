...
namespace BotForge.Mcp.Prompts;
...
public class FrameworkPrompts
{
    [McpServerPrompt]
    [Description(
        "Guides AI to create a correct BotForge handler with full framework context, conventions, and the user's requirements.")]
        ...
        string description)
    {
        ...
        [
            new ChatMessage(ChatRole.System, $"""
                                              You are creating a BotForge handler. Follow these conventions strictly:
    ...
    [McpServerPrompt]
    [Description(
        "Guides AI to create a YAML template file for BotForge with proper syntax, translations, and keyboard configuration.")]
    ...
    {
        var systemPrompt = """
                           You are creating a BotForge YAML template. Follow this syntax:
    ...
    [McpServerPrompt]
    [Description(
        "Guides AI to migrate custom Telegram bot code to BotForge framework — analyzes source code and produces mapped handler/messaging code.")]
        ...
        string sourceCode)
    {
        ...
        [
            new ChatMessage(ChatRole.System, """
                                             You are migrating custom Telegram bot code to the BotForge framework.
                                             ...
                                             OUTPUT FORMAT:
                                             - For each identified pattern, generate the BotForge equivalent
                                             ...
                                             """),
            new ChatMessage(ChatRole.User, $"Migrate this code to BotForge:\n\n```csharp\n{sourceCode}\n```")
        ];
    }

    [McpServerPrompt]
    [Description(
        "Guides AI to implement a complete payment flow in BotForge — invoice creation, checkout validation, payment processing, refunds.")]
        ...
        string description)
    {
        ...
        [
            new ChatMessage(ChatRole.System, """
                                             You are implementing a payment flow in BotForge. Follow this architecture:
    ...
    [McpServerPrompt]
    [Description(
        "Comprehensive bot setup guide — returns a prompt with all registration patterns, architecture layers, and conventions for setting up a new BotForge bot from scratch.")]
    public static IEnumerable<ChatMessage> SetupBot()
    {
        return
        [
            new ChatMessage(ChatRole.System, """
                                             You are helping set up a new BotForge bot project. Provide complete guidance.
                                             ...
                                             REQUIRED PACKAGES:
                                             - BotForge.Consumer — update consumption
                                             - BotForge.Routing — handler dispatch
                                             - BotForge.Messaging — message sending
                                             - BotForge.Templates — YAML template engine (recommended)
                                             - BotForge.Payments — payment system (optional)
            ...
            new ChatMessage(ChatRole.User,
                "Help me set up a new BotForge bot project. Ask me what features I need and generate the complete setup.")
        ];
    }

    [McpServerPrompt]
    [Description(
        "Diagnoses routing and handler dispatch issues in BotForge — common problems, checklist, and resolution steps.")]
        ...
        string symptom)
    {
        ...
        [
            new ChatMessage(ChatRole.System, """
                                             You are diagnosing a BotForge routing issue. Check these in order:
