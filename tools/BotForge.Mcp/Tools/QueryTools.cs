...
public static class QueryTools
{
    [McpServerTool]
    [Description(
        "Returns a complete reference of all BotForge handler interfaces, their context classes, attributes, and result types. Use this to understand what handler types are available and how to implement them.")]
    public static string ListHandlerTypes()
    {
        return """
               # BotForge Handler Types
    ...
    [McpServerTool]
    [Description(
        "Returns the complete YAML template syntax reference for BotForge templates — structure, translations, mustache variables, conditionals, loops, formatters, partials, layouts, static/dynamic buttons, pagination, emoji.")]
    public static string ListTemplateSyntax()
    {
        return """
               # BotForge Template Syntax (YAML)
    ...
    [McpServerTool]
    [Description(
        "Returns all DI registration extension methods for BotForge — AddTelegramRouting, AddTelegramMessaging, AddTelegramTemplates, AddTelegramConsumer, AddTelegramPayments — with their full options.")]
    public static string ShowRegistrationPatterns()
    {
        return """
               # BotForge DI Registration Patterns
