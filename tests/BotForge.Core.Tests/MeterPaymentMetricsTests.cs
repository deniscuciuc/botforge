...
public class MeterPaymentMetricsTests
{
    ...
    public void PaymentFailed_UsesBoundedReasonLabels()
    {
        ...
        var records = capture.ForInstrument("botforge.telegram.payments.payment.outcome")
    ...
    public void AntiFraudCheck_UsesBoundedCheckLabels()
    {
        ...
        var records = capture.ForInstrument("botforge.telegram.payments.antifraud.check").ToArray();
