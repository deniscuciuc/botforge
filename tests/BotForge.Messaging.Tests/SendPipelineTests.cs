...
public class TelegramMessagingOptionsTests
{
    ...
    private sealed class TestRateLimitStore : BotForge.RateLimiting.Abstractions.IRateLimitStore
    {
        public Task<BotForge.RateLimiting.Abstractions.RateLimitResult> AcquireAsync(
            string key, BotForge.RateLimiting.Abstractions.RateLimitPolicy policy,
            CancellationToken ct = default)
        {
            return Task.FromResult(BotForge.RateLimiting.Abstractions.RateLimitResult.Allowed());
        }
