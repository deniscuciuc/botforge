...
namespace TeleForge.Routing.Metrics;

internal static class RoutingMetrics
{
    private const string MeterName = "TeleForge.Routing";
    ...
    private static readonly Counter<long> HandlerCalls =
        Meter.CreateCounter<long>("teleforge.telegram.routing.handler.calls", "{call}",
    ...
    private static readonly Histogram<double> HandlerLatencyMs =
        Meter.CreateHistogram<double>("teleforge.telegram.routing.handler.latency", "ms",
