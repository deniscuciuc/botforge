...
using TeleForge.Payments.Gift;
using TeleForge.Payments.Invoice;
using TeleForge.Payments.Metrics;
using TeleForge.Payments.PaidMedia;
using TeleForge.Payments.Payout;
using TeleForge.Payments.Refund;
using TeleForge.Payments.Revenue;
using TeleForge.Payments.Router;
using TeleForge.Payments.Subscription;
using TeleForge.Payments.Transaction;
using TeleForge.Payments.Wallet;

namespace TeleForge.Payments.Extensions;

public static class PaymentsServiceCollectionExtensions
{
    /// <summary>
    /// Registers TeleForge.Payments services.
    /// </summary>
