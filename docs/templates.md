...
If you want templates to read strings from `BotForge.Localization` instead of duplicating per-language text blocks, add the bridge package and register it after `AddTelegramTemplates()`:
